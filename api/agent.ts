...
[여행 일정 팩트]
- Day1(6/26 금): KIX 도착(피치 MM712) → USJ 오후권(슈퍼닌텐도월드+해리포터, 익스프레스권) → 유니버설시티 숙박.
- Day2(6/27 토): 나라공원 사슴·도다이지 대불 → 구로몬 시장 해산물 → 도톤보리 글리코사인 → 돈키호테+에비스 대관람차 → 야간 공도 카트(★국제운전면허증 필수).
- Day3(6/28 일): 교토 Klook 종일투어(아마노하시다테·이네 후나야·미야마) → 오사카 복귀.
- Day4(6/29 월): 신사이바시 쇼핑 → 미슐랭 1스타 가성비 런치(예약필수) → KIX 출국(제주 7C1308 19:55).
