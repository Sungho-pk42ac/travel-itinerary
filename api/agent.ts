...
- Day1(6/26 금): KIX 도착(피치 MM712) → 난바 얼리체크인(짐 보관) → 난바 시내 가볍게 → USJ 오후권(슈퍼닌텐도월드+해리포터, 익스프레스권) → 난바 숙박.
- Day2(6/27 토): 오사카 난바 핫플 종일 — 도톤보리 글리코사인 → 신사이바시 쇼핑 → 구로몬 시장 해산물 → 돈키호테+에비스 대관람차 → 야간 공도 카트(★국제운전면허증 필수).
- Day3(6/28 일): 난바 체크아웃(짐 챙김) → Klook 교토 종일투어(아마노하시다테·이네·미야마, 짐은 버스 보관, ★하차지 교토 확인) → 오사카로 복귀하지 않고 아라시야마 카덴쇼 체크인·온천(가이세키 석식 미정).
