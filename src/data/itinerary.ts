...
export const itinerary: Day[] = [
  {
    ...
    activities: [
      ...
      },
      {
        ...
        transport: '난카이 라피트 예약완료 · 약 45분',
        cost: '₩24,000(라피트 2인)',
        note: '라피트(간사이공항→난바) 티켓 예약완료 · 체크인 전이라 짐만 프런트 보관',
        rain: 'indoor',
      },
      {
        time: '12:00',
      ...
      },
      {
        ...
        reason: '마일스톤 핵심 체험',
        transport: '도보',
        cost: '₩360,000(1일권+익스프레스)',
        meal: '파크 내 테마푸드',
        note: '★ 오후권(트와일라잇) 품절 → 1일권으로 오후 입장 · 슈퍼닌텐도월드·해리포터 익스프레스권 필수',
        poiId: 'usj',
        highlight: true,
        rain: 'mixed',
      },
  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        transport: '도보',
        cost: '₩140,000',
        note: '★ 국제운전면허증(IDP) 지참 필수 · 예약완료(20:30)',
        poiId: 'kart',
        highlight: true,
        rain: 'outdoor',
      },
  ...
  },
  {
    ...
    activities: [
      ...
      {
        time: '09:00',
        title: '교토 종일투어 (아마노하시다테·이네)',
        reason: '아마노하시다테 케이블카·이네 후나야',
        transport: '전세버스',
        note: 'Trip.com 예약완료 · 점심 포함여부 확인 · 우천시 투어사 진행 · 짐은 버스 보관',
        poiId: 'kyoto',
        highlight: true,
        rain: 'mixed',
      },
  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        title: '교토역 → KIX 공항 이동',
        reason: '출국 버퍼 확보',
        transport: 'JR 하루카 특급 예약완료 · 약 75~80분',
        cost: '₩40,000',
        note: '하루카(교토역→간사이공항) 예약완료 · ★ 19:55 출발이라 늦어도 16:30 도착 목표',
      },
      {
        time: '16:30',
